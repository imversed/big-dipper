...
import { AttributeToProjector, Bounds, IAccessor, IEntityBounds, IRangeProjector, Point, Range, SimpleSelection } from "../core/interfaces";
...
export declare class Plot extends Component {
    static OPTIMIZE_MEMOIZE_PROJECTORS: boolean;
     ...
     */
    protected _createNodesForDataset(dataset: Dataset): Drawers.ProxyDrawer;
    /**
     ...
     */
    attr(attr: string, attrValue: number | string | IAccessor<number> | IAccessor<string> | IAccessor<boolean>): this;
    /**
    ...
    protected _bindProperty(property: string, valueOrFn: any | Function, scale: Scale<any, any>, postScale?: IRangeProjector<any>): void;
    protected _bindAttr(attr: string, valueOrFn: any | Function, scale: Scale<any, any>): void;
    private _cachedAttrToProjector;
    protected _clearAttrToProjectorCache(): void;
    protected _getAttrToProjector(): AttributeToProjector;
    protected _generateAttrToProjector(): AttributeToProjector;
    renderImmediately(): this;
    renderLowPriority(): this;
    /**
    ...
    protected getExtentsForAttr(attr: string): any[][];
    /**
     * Override in subclass to add special extents, such as included values
     */
    protected getExtentsForProperty(property: string): any[][];
    private _includedValuesForScale<D>(scale, ignoreAttachState?);
    /**
     ...
     * @return {Plots.PlotEntity[]}
     */
    filterEntities(where: (entity: Plots.ILightweightPlotEntity, index: number) => boolean): Plots.IPlotEntity[];
    /**
     ...
     */
    entityNearest(queryPoint: Point): Plots.IPlotEntity;
    /**
     ...
     * @returns {PlotEntity[]}
     */
    entitiesIn(bounds: Bounds): Plots.IPlotEntity[];
    /**
     * @deprecated Use `entitiesInBounds` instead
     *
     ...
     * @returns {PlotEntity[]}
     */
    entitiesIn(xRange: Range, yRange: Range): Plots.IPlotEntity[];
    /**
