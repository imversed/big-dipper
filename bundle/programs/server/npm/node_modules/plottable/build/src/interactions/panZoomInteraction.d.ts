...
export declare type PanZoomUpdateCallback = () => void;
export declare type WheelFilter = (wheelEvent: WheelEvent) => boolean;
export declare class PanZoom extends Interaction {
    ...
    private _panZoomUpdateCallbacks;
    /**
     ...
     */
    wheelFilter(filter: WheelFilter): this;
    /**
     ...
     * values. Default true.
     */
    zoom(zoomAmount: number, centerValue?: Point, constrained?: boolean): {
        zoomAmount: number;
        centerValue: {
            centerX: number;
            centerY: number;
     ...
     * @returns {this} The calling PanZoom Interaction.
     */
    onPanZoomUpdate(callback: PanZoomUpdateCallback): this;
    /**
     ...
     * @returns {this} The calling PanZoom Interaction.
     */
    offPanZoomUpdate(callback: PanZoomUpdateCallback): this;
}
