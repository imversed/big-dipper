...
export declare function entityBounds(element: Element): IEntityBounds;
/**
 ...
 */
export declare function getHtmlElementAncestors(elem: Element): HTMLElement[];
/**
 ...
 */
export declare function getElementTransform(elem: Element): ICssTransformMatrix | null;
